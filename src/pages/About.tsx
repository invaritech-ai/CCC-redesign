        ...
        <div className="min-h-screen flex flex-col">
            ...
            <main id="main-content" className="flex-1">
                ...
                <AboutCommitmentSection
                    ...
                    paragraphs={[
                        "While our residential home at 63 Cumberland Road undergoes an exciting redevelopment, our dedication to the English-speaking elderly community remains unwavering. We have temporarily suspended residential services to build a state-of-the-art modern facility, expected to reopen by 2028/early 2029. In the interim, CCC has intensified its focus on supporting elders in the wider community. We currently serve 80+ active Community Members of diversified nationalities, providing vital social connections and activities to combat isolation and loneliness. Our team also continues to pay regular visits to former residents, ensuring their ongoing well-being and connection to the CCC family.",
                    ]}
                    stats={[
                        { number: "80+", label: "Current Community Members" },
                        {
                            number: "130+",
                            label: "Enquiries for residential places upon reopening",
                        },
                        {
                            number: "90+",
                            label: "Persons on the waiting list for a place",
                        },
                    ]}
                />
