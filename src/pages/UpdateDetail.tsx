    ...
    <div className="prose prose-lg max-w-none">
      {blocks.map((block: any, index: number) => {
        if (block._type === 'block') {
          ...
          switch (block.style) {
            case 'h1':
              return <h1 key={index} className="text-4xl font-bold mb-4 mt-8">{text}</h1>;
            case 'h2':
              return <h2 key={index} className="text-3xl font-bold mb-3 mt-6">{text}</h2>;
            case 'h3':
              return <h3 key={index} className="text-2xl font-semibold mb-2 mt-4">{text}</h3>;
            case 'h4':
              return <h4 key={index} className="text-xl font-semibold mb-2 mt-4">{text}</h4>;
            case 'blockquote':
              return <blockquote key={index} className="border-l-4 border-primary pl-4 italic my-4">{text}</blockquote>;
            default:
        ...
        <main className="flex-1">
          <section className="bg-primary text-primary-foreground py-20">
            <div className="container mx-auto px-4">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Update</h1>
            </div>
          </section>
