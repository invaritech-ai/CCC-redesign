...
const Waitlist = () => {
    ...
    const fetchData = async () => {
      try {
        const [content, form] = await Promise.all([
          getPageContent("waitlist"),
          getFormByPage("waitlist"),
        ]);
  ...
  useEffect(() => {
    ...
    const description = pageContent.subheading || 
      "Join the waitlist for our care home. Get notified when spaces become available.";
    
    const canonicalUrl = `https://chinacoastcommunity.org/waitlist`;
            ...
            <div className="container mx-auto px-4 w-full">
              <div className="max-w-4xl md:mx-auto md:text-center">
                ...
                <p className="text-lg md:text-xl max-w-3xl leading-relaxed opacity-90 md:mx-auto">
                  Care Home waitlist introduction and form.
                </p>
              </div>
            </div>
          </section>
