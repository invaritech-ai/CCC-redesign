...
const NAV_ITEMS: NavItem[] = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                href: "/who-we-are/board-governance",
            },
            {
                label: "Publications",
                children: [
                ...
                <nav className="flex items-center justify-between">
                    ...
                    <div className="md:hidden flex items-center gap-3">
                        ...
                        >
                            ...
                            <SheetContent
                                side="right"
                                className="!w-[300px] sm:!max-w-[300px] overflow-y-auto bg-card text-card-foreground [&>button]:text-card-foreground"
                            >
...
const DesktopDropdownItem = ({ item }: { item: NavItem }) => {
    ...
    return (
        <li className="space-y-1">
            <div className="block select-none rounded-md px-3 py-2 text-sm font-semibold leading-none text-muted-foreground">
                {item.label}
            </div>
