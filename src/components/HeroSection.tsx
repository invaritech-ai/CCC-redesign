          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                Your support helps us create a safe, modern home to reopen stronger. Together, we're building a compassionate community where every senior is valued and cared for with dignity.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-foreground font-medium">Section 88 Charity</span>
              </div>
              <div className="flex items-center gap-2">
                <Award className="h-5 w-5 text-success" />
                <span className="text-foreground font-medium">45+ Years Serving HK</span>
              </div>
              <div className="flex items-center gap-2">
                <Users className="h-5 w-5 text-success" />
                <span className="text-foreground font-medium">80+ Community Members</span>
              </div>
            </div>
